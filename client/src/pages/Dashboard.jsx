    ...
    <>
      <div>
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <hr className="border-slate-300 my-5 sm:w-[305px]" />
          ...
          {showCreateResume && (
            ...
            >
              <div
                ...
                className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-5"
              >
                ...
                <input
                  ...
                  className="w-full px-4 py-2 mb-4 focus:border-green-600 ring-green-600 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-green-500"
                  required
                />
                <button
                  type="submit"
