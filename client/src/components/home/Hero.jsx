            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-3 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        ...
                        <Link to="#ats-checker" className="hover:text-green-600 transition">ATS Score</Link>
                        ...
                        <Link to="/pricing" className="hover:text-green-600 transition">Pricing</Link>
                        <Link to="#faqs" className="hover:text-green-600 transition">FAQs</Link>
                        <Link to="#cta" className="hover:text-green-600 transition">Contact</Link>
                    </div>

                    <div className="flex gap-3">
                        <Link href="" className="hidden md:block px-6 py-2 bg-green-500 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>
                        <Link href="" className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900" >
                            Login
                        </Link>
                    </div>
...
<Link to="#ats-checker" className="text-white">ATS Score</Link>

<Link to="#templates" className="text-white">Templates</Link>
...
<p className="max-w-2xl text-center text-base my-7 text-zinc-600">
    Create professional resumes, analyze ATS scores, and optimize your profile with smart AI tools designed to help you land your dream job faster.
</p>
    ...
    <div className="marquee-track">
        ...
        {[...companyLogos, ...companyLogos].map((company, index) => (
            <img
                ...
                alt={company}
                className="h-10 w-auto mx-8 brightness-0 opacity-40 shrink-0"
                draggable={false}
            />
        ))}
